...
use App\Http\Controllers\PovPageController;
...
Route::get('/pov', [PovPageController::class, 'index'])->name('povs.index');
Route::get('/pov/{pov}', [PovPageController::class, 'show'])->name('povs.show');
