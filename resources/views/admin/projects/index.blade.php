<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.projects.create') }}" class="px-4 py-2 bg-gray-800 text-white rounded-md text-sm">Add New Project</a>
        </div>
    </x-slot>
            ...
            <div class="bg-white shadow sm:rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-4 py-3">
                                    @if($project->thumbnail_path)
                                        <img src="{{ asset('storage/' . $project->thumbnail_path) }}" class="h-12 w-12 object-cover rounded">
                                    @else
                                ...
                                <td class="px-4 py-3 space-x-2">
                                    <a href="{{ route('admin.projects.edit', $project) }}" class="text-blue-600 text-sm">Edit</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-6 text-center text-gray-500">No projects yet. Add your first one!</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
